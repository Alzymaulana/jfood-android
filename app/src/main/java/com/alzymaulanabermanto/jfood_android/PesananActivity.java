    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                switch (selected){
                    ...
                    case "Via CASHLESS":
                        ...
                        PromoRequest promoRequest = new PromoRequest(responseListener);
        ...
        mOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RadioButton radioButton = findViewById(radioId);
                String selected = radioButton.getText().toString();
                PesananRequest pesananRequest = null;
                ...
                Response.Listener<String> responseListener = new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (response != null){
                                Toast.makeText(PesananActivity.this, "Order successful", Toast.LENGTH_SHORT).show();

                            }
                        } catch (JSONException e) {
                            Toast.makeText(PesananActivity.this, "Order failed", Toast.LENGTH_SHORT).show();
                ...
                if(selected.equals("Via CASH")){
                    pesananRequest = new PesananRequest(newFoodList.substring(0, newFoodList.length()-1), currentUserId+"", responseListener);
                }
                else if(selected.equals("Via CASHLESS")){
                    pesananRequest = new PesananRequest(newFoodList.substring(0, newFoodList.length()-1), currentUserId+"", mPromoCode.getText().toString(), responseListener);
                }
